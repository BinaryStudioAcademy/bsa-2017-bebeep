...
return [
    ...
    */
    ...
    'max_seats_from_vehicle' => 'Перевищено максимальну кількість місць для сидіння',
    'greater_than_date' => 'Обрана дата більше ніж :attribute',
    'role_can_uncheck' => ':attribute не може бути знятим.',
    'is_password_current' => 'Цей пароль не є поточним.',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    'custom'               => [
        'email' => [
            'exists' => 'Введена :attribute не існує',
        ],
    ],
    /*
    |--------------------------------------------------------------------------
