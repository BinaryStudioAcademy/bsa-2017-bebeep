...
return [
    ...
    */
    ...
    "max_seats_from_vehicle" => 'Превышено максимальное количество мест для сидения',
    "greater_than_date" => 'Выбранная дата больше чем :attribute',
    "role_can_uncheck" => ':attribute не может быть снят.',
    "is_password_current" => 'Этот пароль не является текущим.',
    /*
    |--------------------------------------------------------------------------
