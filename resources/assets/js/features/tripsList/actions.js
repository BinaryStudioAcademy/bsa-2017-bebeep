...
const tripsData = [
    ...
    {id: 4,from:['49.82380909','24.03808194'], to:['60.55372551','25.59814053'], brand: 'Car4', model: '2', start_at:'2017-09-10 08:21:31', end_at:'2017-08-10 09:21:31'},
...
//     return dispatch => {
//         axios.get('api/v1/trips?user_id='+user_id)
//             .then(response => {
//                 dispatch(getTrips(response.data));
//                 dispatch(filterPast(response.data));
//                 dispatch(filterUpcoming(response.data));
//             })
//     };
// }
//
