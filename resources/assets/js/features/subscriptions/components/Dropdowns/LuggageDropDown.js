                ...
                <div className="filter__prop">
                    <div className="filter__prop-control">
                        <div className="filter__prop-name subscribe-modal-name">
                            {translate('subscriptions.luggage_size')}
                        </div>
                        <select name="luggage" value={value || ''} className="form-control" id="luggage" onChange={onChange}>
                            ...
                            <option value="0">{translate('subscriptions.luggage_size_0')}</option>
                            <option value="1">{translate('subscriptions.luggage_size_1')}</option>
                            <option value="2">{translate('subscriptions.luggage_size_2')}</option>
                        </select>
                    </div>
                </div>
        );
