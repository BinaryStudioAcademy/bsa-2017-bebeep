...
class CompaundTripItem extends React.Component {
        ...
        return (
            <Link to={`/trip/${collection.trip.id}`} className="search-trip-item">
                <div className="row search-trip-item-block">
                    ...
                    {console.log(collection.from.address_components[0])}

                    </div>
                    <div className="search-trip-item__trip-container col-sm-8 clearfix">
                        {/*<h3>{(from[0].long_name === parseInt(from[0].long_name, 6)) ? from[1].long_name:from[0].long_name}</h3>*/}
                        {/*-*/}
                        {/*<h3>{(to[0].long_name === parseInt(to[0].long_name, 6)) ? to[1].long_name:to[0].long_name}</h3>*/}
...
export default localize(CompaundTripItem, 'locale');