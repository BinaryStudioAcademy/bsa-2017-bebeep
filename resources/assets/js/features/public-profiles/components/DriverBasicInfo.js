    ...
    render() {
        ...
        return (
            <div className="text-center">
                <img src={img ? (img) : 'http://www.theenergycollective.com/wp-content/plugins/userpro/img/default_avatar_male.jpg'} width="150" height="150" className="rounded-circle driver-avatar" />
